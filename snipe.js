...
exports.run = async (client, message, args) => {
  ...
  .setTitle('İŞTE SON SİLİNENLER');
  if(embed.description.length > 4000) return createEmbed('Silinen mesajların arasında çok uzun bir mesaj bulunduğu için bunu gösteremiyorum.', 'RED');
