...
exports.run = async (client, message, args) => {// can#0002
  ...
  if(!message.mentions.channels.first()) return message.channel.send(`<a:uyari:849328399809380382>  Bu Özelliği Ayarlamam İçin Bir Kanal Etiketlemelisin Örnek: x!kayıt-kanal #kayitkanal`);
